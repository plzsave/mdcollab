  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 dark:bg-slate-950">
      <div className="w-full max-w-sm rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-8 shadow-sm">
        ...
        <a
          href="/api/auth/login"
          className="mt-6 flex w-full items-center justify-center rounded-lg bg-slate-800 dark:bg-slate-700 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-slate-700 dark:hover:bg-slate-600"
        >
          Google でログイン
        </a>
