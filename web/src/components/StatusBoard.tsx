    ...
    <div className="mt-6 flex gap-3 overflow-x-auto pb-4">
      {columns.map((col) => {
        ...
        return (
          <div
            key={col.key}
            className="flex w-64 shrink-0 flex-col rounded-lg bg-slate-100/70 p-2 dark:bg-slate-800/50"
          >
...
function BoardCard({
  ...
  return (
    <div
      className={`rounded-md border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-2.5 shadow-sm ${
    ...
    >
      ...
      <div className="mt-2 space-y-1.5">
        <select
          ...
          className="w-full rounded border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-1.5 py-1 text-[11px] text-slate-600 dark:text-slate-300 focus:border-slate-400 focus:outline-none"
        >
