...
function AiSettingsView() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <h1 className="text-xl font-bold text-slate-800">AI 設定</h1>

      <section className="space-y-3 rounded-lg border border-slate-200 bg-white p-5">
        <h2 className="text-sm font-semibold text-slate-700">プロバイダとモデル</h2>
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="text-[11px] text-slate-500 hover:text-slate-800 disabled:opacity-40"
          >
            候補を取得
          </button>
        </div>
      ...
      <section className="space-y-3 rounded-lg border border-slate-200 bg-white p-5">
        <h2 className="text-sm font-semibold text-slate-700">GitHub リポジトリ（レビュー参照）</h2>
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 rounded border border-slate-200 px-3 py-2 text-sm focus:border-slate-400 focus:outline-none"
          />
          <button
